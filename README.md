...
> 297 道高质量题目（167 单选 + 130 多选）+ 领域分类练习 + 自定义练习 + 模拟考试 + 完整持久化进度追踪

---

## ✨ 功能亮点

- **297 道精选题目**（167 单选 + 130 多选），全部配有详细解析和「重点考点」补充；Cloud / Security 领域已针对性补题
...
- **总规模**：297 题（167 单选 + 130 多选）
- **ID 范围**：单选 S01–S172，多选 M01–M130
- **领域分布**（更接近 CLF-C02 官方权重 24% / 30% / 34% / 12%）：

| 领域 | 单选 | 多选 | 总计 | 占比 |
|------|------|------|------|------|
| Cloud Concepts（云概念） | 33 | 33 | 66 | 22.2% |
| Security and Compliance（安全与合规） | 48 | 35 | 83 | 27.9% |
| Technology and Services（技术与服务） | 61 | 36 | 97 | 32.7% |
| Billing, Pricing, and Support（账单定价与支持） | 25 | 26 | 51 | 17.2% |
| **总计** | **167** | **130** | **297** | 100% |
...
├── data/
│   ├── __init__.py         # 数据层统一出口
│   ├── single_choice.py    # 167 道单选题
│   ├── multi_choice.py     # 130 道多选题
